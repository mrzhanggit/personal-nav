...
export function TopBar() {
  ...
  return <header className="topbar"><a href="#home" className="brand"><svg viewBox="0 0 32 32" aria-hidden="true"><path d="m4 26 12-21 12 21-12-7Z M4 26l12-4 12 4" /></svg><span><strong>ZCB</strong><i>/</i> PERSONAL OS</span></a><span className="brand-tagline">A MORE FOCUSED, MORE ME</span><div className="top-actions"><button className="icon-button" disabled aria-label="搜索尚未开放"><Icon name="search" /></button><button className="icon-button" disabled aria-label="设置尚未开放"><Icon name="settings" /></button><time>{time}</time><span className="avatar" aria-label="ZCB">Z</span></div></header>
}
